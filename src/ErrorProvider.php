...
class ErrorProvider {
    ...
    const IS_NOT_STR  =
        '<NAME> darf nur aus Zahlen und Buchstaben A-Z bestehen.';
    const IS_NOT_FN   =
        '<NAME> darf nur \'a-z\', \'A-Z\', \'0-9\', \'.\' und \'_\' bestehen.';
